...
add wave -noupdate -radix unsigned /router_reg_tb/datain
...
add wave -noupdate -radix unsigned /router_reg_tb/dout
add wave -noupdate -radix unsigned /router_reg_tb/i
add wave -noupdate -radix unsigned /router_reg_tb/packet1/header
add wave -noupdate -radix unsigned /router_reg_tb/packet1/payload_data
add wave -noupdate -radix unsigned /router_reg_tb/packet1/parity
add wave -noupdate -radix unsigned /router_reg_tb/packet1/payloadlen
add wave -noupdate -radix unsigned /router_reg_tb/packet2/header
add wave -noupdate -radix unsigned /router_reg_tb/packet2/payload_data
add wave -noupdate -radix unsigned /router_reg_tb/packet2/parity
add wave -noupdate -radix unsigned /router_reg_tb/packet2/payloadlen
...
add wave -noupdate -radix unsigned /router_reg_tb/DUT/datain
...
add wave -noupdate -radix unsigned /router_reg_tb/DUT/dout
add wave -noupdate -radix unsigned /router_reg_tb/DUT/hold_header_byte
add wave -noupdate -radix unsigned /router_reg_tb/DUT/fifo_full_state_byte
add wave -noupdate -radix unsigned /router_reg_tb/DUT/internal_parity
add wave -noupdate -radix unsigned /router_reg_tb/DUT/packet_parity_byte
